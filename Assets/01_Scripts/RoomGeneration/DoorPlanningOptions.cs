...
namespace Octoplug.RoomGeneration
{
    ...
    {
        public DoorPlanningOptions(
            float doorWidth,
            float safetyMargin,
            IReadOnlyDictionary<RoomWallId, IReadOnlyList<CoordinateInterval>> extraBlockedIntervals = null)
        {
            ...
            ExtraBlockedIntervals = extraBlockedIntervals;
        }

        public float DoorWidth { get; }
        public float SafetyMargin { get; }
        public IReadOnlyDictionary<RoomWallId, IReadOnlyList<CoordinateInterval>> ExtraBlockedIntervals { get; }
